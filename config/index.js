export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx2fb8ce5ce83d09f4",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "6f7787e58d356799419ae4a69c328ac8",
  ...
  USERS: [
    {
      ...
      id: "o3kuC6syZJqbbsokfQpQ8JKRP0Kg",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "T-jiyrALT2Nh2kW_e3Dzegxu17308BZ9eSJZzITt6Sc",
      // 所在省份
      province: "河北",
      // 所在城市
      city: "廊坊",
  ...
  SLOT_LIST: [
    ...
    {"keyword": "lover_prattle", contents: [
      ...
      "遇见你，就好像捡到了100斤的运气",
      "不管春水初生，春林初盛，春风十里不如你。而是遇见你，微风起，新柳生绿意，蜂蝶翻飞花丛里，眼上眉梢皆是喜。",
    ]},
    // 你可以不断按格式往下增加
    // ...
  ],
